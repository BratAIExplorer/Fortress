...
export const usMockStocks: Stock[] = [
    { id: "us-1", symbol: "AAPL", name: "Apple Inc.", sector: "Technology", current_price: 185.2, quality_score: 95, market_cap_crores: 24000000, megatrend: ["Consumer Tech", "Services"], is_active: true, market: "US" },
    { id: "us-2", symbol: "MSFT", name: "Microsoft Corp.", sector: "Technology", current_price: 415.5, quality_score: 97, market_cap_crores: 26000000, megatrend: ["Cloud", "AI"], is_active: true, market: "US" },
    { id: "us-3", symbol: "GOOGL", name: "Alphabet Inc.", sector: "Technology", current_price: 155.8, quality_score: 93, market_cap_crores: 16000000, megatrend: ["AI", "Search"], is_active: true, market: "US" },
    { id: "us-4", symbol: "AMZN", name: "Amazon.com Inc.", sector: "Technology", current_price: 178.4, quality_score: 91, market_cap_crores: 15000000, megatrend: ["Cloud", "E-commerce"], is_active: true, market: "US" },
    { id: "us-5", symbol: "NVDA", name: "NVIDIA Corp.", sector: "Technology", current_price: 880.2, quality_score: 98, market_cap_crores: 18000000, megatrend: ["AI", "Gaming"], is_active: true, market: "US" },
    { id: "us-6", symbol: "META", name: "Meta Platforms", sector: "Technology", current_price: 510.5, quality_score: 90, market_cap_crores: 11000000, megatrend: ["Metaverse", "Ads"], is_active: true, market: "US" },
    { id: "us-7", symbol: "TSLA", name: "Tesla, Inc.", sector: "Automobile", current_price: 175.2, quality_score: 82, market_cap_crores: 4500000, megatrend: ["EV", "Energy"], is_active: true, market: "US" },
    { id: "us-8", symbol: "BRK.B", name: "Berkshire Hathaway", sector: "Financial", current_price: 410.5, quality_score: 96, market_cap_crores: 7500000, megatrend: ["Value", "Insurance"], is_active: true, market: "US" },
    { id: "us-9", symbol: "V", name: "Visa Inc.", sector: "Financial", current_price: 280.2, quality_score: 94, market_cap_crores: 4800000, megatrend: ["Payments"], is_active: true, market: "US" },
    { id: "us-10", symbol: "JPM", name: "JPMorgan Chase", sector: "Banking", current_price: 195.8, quality_score: 89, market_cap_crores: 4600000, megatrend: ["Financialization"], is_active: true, market: "US" },
];

export const usV5LowStocks: Stock[] = [
    { id: "uv5-1", symbol: "NKE", name: "Nike, Inc.", sector: "Consumer", industry: "Footwear", current_price: 92.5, drop52w: -35, debt_to_equity: 0.6, roce_5yr_avg: 28.4, ocf: "5/5", moat: "Global Brand Dominance", l1: 5, l2: 5, l3: 3, l4: 3, l5: 5, why_down: "Direct-to-consumer pivot friction + slow innovation cycle.", why_buy: "Nike is down but the swoosh is eternal. 28% ROCE at a rare valuation discount.", tag: "QUALITY ON SALE", risk: "LOW", quality_score: 82, is_active: true, megatrend: ["Consumption"], market_cap_crores: 1100000, market: "US" },
    { id: "uv5-2", symbol: "SBUX", name: "Starbucks Corp.", sector: "Consumer", industry: "Restaurants", current_price: 88.2, drop52w: -22, debt_to_equity: 0.8, roce_5yr_avg: 45.2, ocf: "5/5", moat: "Third Place Advantage", l1: 4, l2: 5, l3: 3, l4: 3, l5: 5, why_down: "China macro slowdown + unionisation headwinds in US.", why_buy: "Dominant pricing power. China recovery is a 'when' not 'if'. High dividend support.", tag: "QUALITY ON SALE", risk: "LOW", quality_score: 80, is_active: true, megatrend: ["Consumption"], market_cap_crores: 850000, market: "US" },
    { id: "uv5-3", symbol: "INTC", name: "Intel Corp.", sector: "Technology", industry: "Semiconductors", current_price: 32.5, drop52w: -45, debt_to_equity: 0.4, roce_5yr_avg: 12.4, ocf: "3/5", moat: "x86 Architecture + Foundry Strategy", l1: 3, l2: 3, l3: 5, l4: 4, l5: 4, why_down: "Losing share to AMD/Nvidia + massive capex for foundry build-out.", why_buy: "Sovereign AI play. US government will not allow Intel to fail. Buying the foundry future at a discount.", tag: "TURNAROUND WATCH", risk: "MEDIUM", quality_score: 68, is_active: true, megatrend: ["Digital India"], market_cap_crores: 1200000, market: "US" },
    { id: "uv5-4", symbol: "PYPL", name: "PayPal Holdings", sector: "Financial", industry: "Payments", current_price: 64.2, drop52w: -40, debt_to_equity: 0.3, roce_5yr_avg: 18.2, ocf: "5/5", moat: "Two-Sided Payment Network", l1: 5, l2: 4, l3: 3, l4: 3, l5: 4, why_down: "Competition from Apple Pay/Zelle + slowing checkout growth.", why_buy: "Extremely cheap at 12x PE. Generating massive FCF and buying back shares aggressively.", tag: "DEEP VALUE", risk: "MEDIUM", quality_score: 72, is_active: true, megatrend: ["Payments"], market_cap_crores: 580000, market: "US" },
    { id: "uv5-5", symbol: "PFE", name: "Pfizer Inc.", sector: "Healthcare", industry: "Pharma", current_price: 28.5, drop52w: -38, debt_to_equity: 0.5, roce_5yr_avg: 15.6, ocf: "4/5", moat: "Global Pharma R&D Scale", l1: 4, l2: 4, l3: 4, l4: 3, l5: 4, why_down: "Post-Covid revenue cliff + Seagen acquisition debt.", why_buy: "6% dividend yield. Pipeline of oncology drugs starting to deliver. Paid to wait.", tag: "PATIENT PICK", risk: "LOW", quality_score: 76, is_active: true, megatrend: ["Healthcare"], market_cap_crores: 1400000, market: "US" },
];

export const usV5PennyStocks: Stock[] = [
    { id: "up-1", symbol: "PLTR", name: "Palantir Technologies", sector: "Technology", industry: "AI Software", current_price: 22.5, drop52w: -15, debt_to_equity: 0.0, roce_5yr_avg: 12.8, ocf: "4/5", moat: "Govt + Enterprise AI Operating System", l1: 5, l2: 5, l3: 5, l4: 5, l5: 5, why_down: "High valuation concerns + lumpy govt contracts.", why_buy: "The actual 'AI' winner. AIP adoption in US commercial sector is exploding. Zero debt.", tag: "🎰 PENNY — QUALIFIED", risk: "MEDIUM", penny_why: "High volatility but institutional-grade software moats. Not a traditional penny stock.", quality_score: 88, is_active: true, megatrend: ["AI"], market_cap_crores: 420000, market: "US" },
    { id: "up-2", symbol: "SOFI", name: "SoFi Technologies", sector: "Financial", industry: "Fintech", current_price: 7.2, drop52w: -35, debt_to_equity: 1.2, roce_5yr_avg: 6.4, ocf: "3/5", moat: "AWS of Fintech (Galileo)", l1: 3, l2: 4, l3: 4, l4: 5, l5: 4, why_down: "High interest rates + student loan moratorium impacts.", why_buy: "Achieved GAAP profitability. Becoming a one-stop-shop for high-income millennials.", tag: "🎰 PENNY — QUALIFIED", risk: "HIGH", penny_why: "Price under $10 but business is scaling rapidly towards sustainable profit.", quality_score: 72, is_active: true, megatrend: ["Financialization"], market_cap_crores: 65000, market: "US" },
];
