...
export const glossaryData: Glossary = {
    ...
    riskLevels: [
        ...
        { level: "EXTREME", color: "#DC2626", emoji: "☠️", plain: "Pure speculation. Could be worth zero tomorrow.", examples: "All Sub-₹10 stocks on this platform" },
    ],
    fortressLayers: [
    ...
    updates: [
        { freq: "QUARTERLY", items: ["Fortress list rebalancing", "5-Layer score updates", "Why Box refreshes", "Penny + Sub-₹10 review"], color: "#4ADE80", why: "Quarterly = Driving School not Taxi Service.", next: "15 Jun 2026" },
