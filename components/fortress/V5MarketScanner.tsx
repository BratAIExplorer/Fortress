            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                    {[
                        ...
                        { id: "L3", label: "Momentum", icon: Activity, col: "text-amber-400", desc: `3M/6M/1Y vs ${market === "NSE" ? "Nifty 50" : "S&P 500"}` },
                        { id: "L4", label: "Growth", icon: TrendingUp, col: "text-purple-400", desc: "EPS & Revenue CAGR" },
                        { id: "L5", label: "Ownership", icon: CheckCircle2, col: "text-rose-400", desc: market === "NSE" ? "Insider + FII Holding" : "Institutional Holding" },
                ...
                <Card className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border-white/10 overflow-hidden text-slate-200">
                    <CardHeader className="p-8 pb-4">
                        <CardTitle className="text-2xl font-bold text-white flex items-center gap-2">
                            ...
                            {market === "NSE" ? "BSE/NSE 5-Layer Scanner" : "Global 6-Layer Scanner"}
                        </CardTitle>
                        <p className="text-slate-400 mt-2 max-w-xl text-sm leading-relaxed">
                            Automated fundamental screening across {market === "NSE" ? "2,000+ NSE stocks" : "5,000+ US stocks"} using 6 proprietary layers.
                        </p>
                    </CardHeader>
                    <CardContent className="p-8 pt-0">
                        <div className="p-8 rounded-xl border border-white/10 bg-white/3 text-center space-y-4">
                            ...
                            <p className="text-slate-400 text-sm max-w-md mx-auto leading-relaxed">
                                The Intelligent Scanner runs on a scheduled basis and refreshes results across all {market} stocks.
                                Fresh scan results are reflected in the <span className="text-amber-400 font-medium">52W Lows</span>, <span className="text-blue-400 font-medium">Qualified Penny</span>, and <span className="text-amber-400 font-medium">{market === "NSE" ? "Sub-₹20 Spec" : "Sub-$2 Spec"}</span> tabs above.
                            </p>
                ...
                <CardHeader className="p-8 pb-4">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div>
                            ...
                            <p className="text-slate-400 mt-2 max-w-xl text-sm leading-relaxed">
                                Automated fundamental screening across {market === "NSE" ? "2,000+ NSE stocks" : "5,000+ US stocks"}.
                ...
                <CardContent className="p-8 pt-4">
                    ...
                    {!isScanning && !lastScanResult && (
                        <div className="p-12 border border-dashed border-white/10 rounded-xl text-center bg-white/2">
                            ...
                            <p className="text-slate-500 text-xs mt-2">Trigger a scan to analyze real-time market data across all {market} stocks.</p>
                        </div>
                    )}
                    ...
                    {!isScanning && lastScanResult && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in zoom-in-95 duration-500">
                            {[
                                ...
                                { label: "Penny (Qualified)", val: "Top 30", sub: market === "NSE" ? "Price < ₹100" : "Price < $5", color: "text-blue-400" },
                                { label: "Speculative", val: "Top 25", sub: market === "NSE" ? "Price < ₹20" : "Price < $2", color: "text-amber-400" },
                            ].map(stat => (
