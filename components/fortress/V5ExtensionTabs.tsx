...
import { TrendingDown, Gem, Flame, Star, Info, Search } from "lucide-react";
...
const TAB_CRITERIA: Record<string, string> = {
    lows: "Quality companies at their cheapest price in a year. These passed our safety checks but the market has temporarily pushed their price down — potential value opportunities.",
    penny: "Small companies with big potential, verified for quality. Each one passed our financial safety filters — real cash flow, manageable debt, and consistent profits. These are not lottery tickets.",
    speculative: "The highest risk, highest reward category. These stocks have structural challenges but genuine turnaround or breakout potential. Only for investors comfortable with the possibility of total loss.",
    picks: "Our highest-conviction selections — the top 10% from across all scans. These scored highest on our multi-factor analysis and represent our strongest ideas.",
    scanner: "Live results from our screening engine, refreshed every scan cycle. Every stock is scored across 6 independent quality checks — you can see exactly why each one qualified.",
    glossary: "Plain-English explanations of every metric and score used across Fortress. If you see a number you don't understand, look it up here.",
};
...
export function V5ExtensionTabs({
    ...
    const tabs = [
        { id: "lows",        label: "Value Picks",            icon: TrendingDown, color: "data-[state=active]:bg-primary" },
        { id: "penny",       label: "Hidden Gems",            icon: Gem,          color: "data-[state=active]:bg-primary" },
        { id: "speculative", label: "High Risk / High Reward", icon: Flame,       color: "data-[state=active]:bg-primary" },
        ...
        { id: "glossary",    label: "How It Works",            icon: Info,         color: "data-[state=active]:bg-cyan-600" },
    ];
