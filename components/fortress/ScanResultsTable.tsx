                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="py-3 px-4">
                                            ...
                                            <span className="text-muted-foreground ml-1 text-[10px]">{row.price ? `${getMarket(row.market).currency}${Number(row.price).toFixed(0)}` : ""}</span>
                                        </td>
                                        ...
                                        <td className="py-3 px-4">
                                            <span className="text-[10px] text-muted-foreground">
                                                {row.category === "52W_LOW" ? "52W Low"
                                                    ...
                                                    : row.category === "SUB20" ? `Sub-${getMarket(row.market).currency}20`
                                                    : row.category ?? "–"}
                                            </span>
                                        </td>
                                    </tr>
